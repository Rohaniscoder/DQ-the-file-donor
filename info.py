...
URL = "https://dq-oooe.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://dq-oooe.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://dq-oooe.onrender.com/".format(FQDN)
else:
    URL = "https://dq-oooe.onrender.com/".format(FQDN)
